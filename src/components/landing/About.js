        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-primary via-primary-light to-gold-dark h-96 flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-white/80 font-display text-xl italic">
                  &ldquo;Reading is to the mind what exercise is to the
                  body.&rdquo;
                </p>
          ...
          >
            ...
            <p className="text-primary-lighter leading-relaxed mb-4">
              Started in 2026, Wisdom Library was born from a simple belief:
              that access to knowledge should be beautiful, comfortable, and
              community-driven. Today, we are home to hundreds of dedicated
              readers, students, and professionals.
            </p>
            <p className="text-primary-lighter leading-relaxed mb-8">
              We don&apos;t just provide books — we create an environment where
              minds flourish, friendships form, and goals are achieved. Become
              part of our ever-growing family.
            </p>
